...
const ignoredHeaders = ["cache-control", "content-security-policy", "content-encoding", "content-length", "cross-origin-opener-policy", "cross-origin-opener-policy-report-only", "report-to", "strict-transport-security", "x-content-type-options", "x-frame-options"];
...
export default headers => {
    ...
    Object.keys(headers).forEach(key => {
        ...
        if (key === "location")
            rewrittenHeaders[key] = rewriteLocation(value);
        else if (key === "cookie")
