 ...
 */
function getRequestUrl(url, path, proxyOrigin, requestOrigin, realOrigin, isFirstRequest, isIframe) {
    ...
    if (absoluteUrl) {
        ...
        if (noPrefix) {
            ...
            return noPrefix.startsWith(proxyOrigin) || isIframe ? noPrefix : `${proxyOrigin}/${noPrefixProto}`;
        }
        else
